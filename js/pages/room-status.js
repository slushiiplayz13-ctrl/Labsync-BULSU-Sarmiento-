...
(function (global) {
  ...
  async function loadAllRoomStatusLabs() {
    ...
    try {
      ...
      if (Array.isArray(cached) && cached.length > 0 && typeof global.renderLabCards === 'function') {
        global.renderLabCards(cached, labsGrid);
      }
    } catch (e) {}
      ...
      const fetchFn = typeof global.fetchLaboratories === 'function'
        ...
        : (global.laboratoryService && typeof global.laboratoryService.fetchLaboratories === 'function'
          ...
          : async () => {
            ...
            try { sessionStorage.setItem('labsync_cached_labs', JSON.stringify(data)); } catch (e) {}
            return data;
          });
  ...
  async function loadRoomStatusActivityLog() {
    ...
    // Instant SWR pre-render from cache
    try {
