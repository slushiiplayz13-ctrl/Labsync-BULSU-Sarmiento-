      ...
      pageEl.innerHTML = `
        ...
        <div class="print-footer-container">
          ...
          <div class="footer-brand" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; opacity: 0.95; align-self: flex-end; padding-bottom: 5px;">
            ...
            <img src="assets/labsync-logo.png" alt="LabSync Logo" class="labsync-print-brand-logo" style="height: 28px; width: auto; object-fit: contain; content: normal !important;">
          </div>
